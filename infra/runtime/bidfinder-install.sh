...
install_units() {
  ...
  write_if_missing "$config_dir/runtime.env" \
    ...
    "BIDFINDER_TYPESENSE_CHECKPOINT=$typesense_root/checkpoints/serving_v1_20260909_vi_clean.sqlite3" \
    "BIDFINDER_TYPESENSE_PROVENANCE=$typesense_root/checkpoints/serving_v1_20260909_vi_clean.uuid.sqlite3" \
    "BIDFINDER_SERVING_REPORT_PATH=$typesense_root/reports/serving-state-serving_v1_20260909_vi_clean.json" \
    "BIDFINDER_SERVING_MARKDOWN_PATH=$typesense_root/reports/serving-state-serving_v1_20260909_vi_clean.md" \
    "BIDFINDER_SERVING_GENERATION=serving_v1_20260909_vi_clean" \
    "BIDFINDER_TYPESENSE_SERVING_GENERATION=serving_v1_20260909_vi_clean" \
