...
BIDFINDER_TYPESENSE_CHECKPOINT="${BIDFINDER_TYPESENSE_CHECKPOINT:-$BIDFINDER_TYPESENSE_ROOT/checkpoints/serving_v1_20260910_raw_v2.sqlite3}"
BIDFINDER_TYPESENSE_PROVENANCE="${BIDFINDER_TYPESENSE_PROVENANCE:-$BIDFINDER_TYPESENSE_ROOT/checkpoints/serving_v1_20260910_raw_v2.uuid.sqlite3}"
BIDFINDER_SERVING_REPORT_PATH="${BIDFINDER_SERVING_REPORT_PATH:-$BIDFINDER_TYPESENSE_ROOT/reports/serving-state-serving_v1_20260910_raw_v2.json}"
BIDFINDER_SERVING_MARKDOWN_PATH="${BIDFINDER_SERVING_MARKDOWN_PATH:-$BIDFINDER_TYPESENSE_ROOT/reports/serving-state-serving_v1_20260910_raw_v2.md}"
...
BIDFINDER_SERVING_GENERATION="${BIDFINDER_SERVING_GENERATION:-serving_v1_20260910_raw_v2}"
